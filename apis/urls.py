...
from .import views
from .views import customer_list , customer_details , ProductView , ProductDetail , GenericAPIView
...
urlpatterns = [
    ...
    path('saleorders/<int:id>/',GenericAPIView.as_view(),name="saleorder-api"),
]